...
// Written: fmk 
//
// Description: This file contains the interface for the TrussCPP class.
// It defines the class interface and the class attributes. TrussCPP 
