...
Matrix beam2d03::m(6,6);  // these beam members have no mass or damping matrices
Matrix beam2d03::d(6,6);
...
beam2d03::beam2d03(int tag, double a, double e, double i, int Nd1, int Nd2)
   :Element(tag,ELE_TAG_beam2d03), A(a),  E(e), I(i), 
    ...
    k(6,6), rForce(6), 
    load(6), trans(6,6), isStiffFormed(0)
{
...
beam2d03::getStiff(void)
{
	...
	if (end1Ptr == 0) {
	    cerr << "beam2d03::getStiff: Nd1: ";
	    cerr << Nd1 << "does not exist in model\n";
	    exit(0);
	}
	if (end2Ptr == 0) {
	    cerr << "beam2d03::getStiff: Nd2: ";
...
const Matrix &
beam2d03::getDamp(void)
{
    return d;
}

const Matrix &
beam2d03::getMass(void)
{ 
    return m;
}
