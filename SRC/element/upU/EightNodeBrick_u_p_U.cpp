           ...
           Ki(0)
{
    ...
    if (perm(0)==0.0 || perm(1)==0.0 || perm(2)==0.0) {
       opserr<<" Error, EightNodeBrick_u_p_U:: permeability (kx/ky/kz) is zero! \n";
       exit(-1);
    }
...
//=============================================================================
Response* EightNodeBrick_u_p_U::setResponse(const char **argv, int argc, OPS_Stream &output)
{
...
//======================================================================
const Vector& EightNodeBrick_u_p_U::getBodyForce ()
{
    static Vector Pforce(Num_ElemDof);
