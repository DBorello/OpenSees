...
//    tensor K(4,K_dim,0.0);
    ...
    for ( int i=1 ; i<=20 ; i++ )  // i<=20 for 20 nodes
      {
        for ( int j=1 ; j<=20 ; j++ )  // i<=20 for 20 nodes
          {
            for ( int k=1 ; k<=3 ; k++ )
              {
                for ( int l=1 ; l<=3 ; l++ )
...
//=============================================================================
Response * TwentyNodeBrick_u_p_U::setResponse (char **argv, int argc, Information &eleInformation) 
{
