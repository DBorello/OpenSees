				   ...
				   TclModelBuilder *theTclBuilder)
{
  ...
  if (List == 0) {
    opserr << "WARNING - TclModelBuilder_addDispBeamColumn - problem merging list\n";
    return TCL_ERROR;
  }
  ...
  if (Tcl_SplitList(interp, List, &argc, &argv) != TCL_OK) {
    opserr <<  "WARNING - TclModelBuilder_addDispBeamColumn - problem spliting list\n";
    return TCL_ERROR;
  }
  ...
  if (argc < 6) {
    ...
    opserr << "Want: element dispBeamColumn eleTag? iNode? jNode? transfTag? ...\n";
    return TCL_ERROR;
  }
  ...
  if (strcmp(argv[6],"Lobatto") == 0 || strcmp(argv[6],"Legendre") == 0 
    ...
    if (argc < 9) {
      opserr << "WARNING insufficient arguments\n";
      printCommand(argc, argv);
      opserr << "Want: element dispBeamColumn eleTag? iNode? jNode? transfTag? Lobatto secTag? nIP?\n";
      return TCL_ERROR;
    }
    ...
    if (argc < 9) {
      opserr << "WARNING insufficient arguments\n";
      printCommand(argc, argv);
      opserr << "Want: element dispBeamColumn eleTag? iNode? jNode? transfTag? UserDefined nIP? secTag1? ... pt1? ... wt1? ...\n";
      return TCL_ERROR;
    }
    ...
    if (argc < 12) {
      opserr << "WARNING insufficient arguments\n";
      printCommand(argc, argv);
      opserr << "Want: element dispBeamColumn eleTag? iNode? jNode? transfTag? type secTagI? lpI? secTagJ? lpJ? secTagE?\n";
      return TCL_ERROR;
    }
    ...
    if (argc < 9) {
      opserr << "WARNING insufficient arguments\n";
      printCommand(argc, argv);
      opserr << "Want: element dispBeamColumn eleTag? iNode? jNode? transfTag? UserHinge E? A? Iz? <Iy? G? J?> npL? secTagL1? ... ptL1? ... wtL1? ... npR? secTagR1? ... ptR1? ... wtR1? ...\n";
      return TCL_ERROR;
    }
    ...
    if (argc < 16) {
      opserr << "WARNING insufficient arguments\n";
      printCommand(argc, argv);
      opserr << "Want: element dispBeamColumn eleTag? iNode? jNode? transfTag? type type nIP? secTagI? lpI? secTagJ? lpJ? E? A? Iz? <Iy? G? J?>\n";
      return TCL_ERROR;
    }
    ...
    if (argc < 9) {
      opserr << "WARNING insufficient arguments\n";
      printCommand(argc, argv);
      opserr << "Want: element dispBeamColumn eleTag? iNode? jNode? transfTag? FixedLocation nIP? secTag1? ... pt1? ... \n";
      return TCL_ERROR;
    }
    ...
    if (argc < 9) {
      opserr << "WARNING insufficient arguments\n";
      printCommand(argc, argv);
      opserr << "Want: element dispBeamColumn eleTag? iNode? jNode? transfTag? LowOrder nIP? secTag1? ... pt1? ... wt1? ...\n";
      return TCL_ERROR;
    }
    ...
    if (argc < 9) {
      opserr << "WARNING insufficient arguments\n";
      printCommand(argc, argv);
      opserr << "Want: element dispBeamColumn eleTag? iNode? jNode? transfTag? MidDistance nIP? secTag1? ... pt1? ... \n";
      return TCL_ERROR;
    }
