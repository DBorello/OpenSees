...
// $Source: /usr/local/cvs/OpenSees/SRC/element/adapter/TclActuatorCommand.cpp,v $
...
//
// What: "@(#) TclActuatorCommand.cpp, revA"
    ...
    TclModelBuilder *theTclBuilder, int eleArgStart)
{
    ...
    if ((argc-eleArgStart) < 6) {
        ...
        opserr << "Want: element actuator eleTag iNode jNode EA ipPort <-rho rho>\n";
        return TCL_ERROR;
    }    
    ...
    theElement = new Actuator(tag, ndm, iNode, jNode, EA, ipPort, rho);
