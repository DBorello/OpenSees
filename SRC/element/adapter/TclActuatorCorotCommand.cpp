...
// $Source: /usr/local/cvs/OpenSees/SRC/element/adapter/TclActuatorCorotCommand.cpp,v $
...
//
// What: "@(#) TclActuatorCorotCommand.cpp, revA"
    ...
    TclModelBuilder *theTclBuilder, int eleArgStart)
{
    ...
    if ((argc-eleArgStart) < 6) {
        ...
        opserr << "Want: element corotActuator eleTag iNode jNode EA ipPort <-rho rho>\n";
        return TCL_ERROR;
    }    
    ...
    theElement = new ActuatorCorot(tag, ndm, iNode, jNode, EA, ipPort, rho);
