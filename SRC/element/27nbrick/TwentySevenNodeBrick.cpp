...
connectedExternalNodes(27), Ki(0), Q(81), bf(3), rho(0.0), pressure(0.0), mmodel(0)
{
     matpoint = 0;
...
void TwentySevenNodeBrick::incremental_Update()
  {
    ...
    if ( ! ( (matpoint[where]->matmodel)->setTrialStrainIncr( incremental_strain)) )
      opserr << "TwentySevenNodeBrick::incremental_Update (tag: " << this->getTag() << "), not converged\n";
...
/*    // influence of the node number 20
    ...
    H.val(22,1)=(1.0+r1)*(1.0-r2)*(1.0-r3)*0.125 - (H.val(43,1)+H.val(48,3)+H.val(81,3))*0.5;
    H.val(23,2)=H.val(22,1); //(1.0+r1)*(1.0-r2)*(1.0-r3)/8.0 - (H.val(43,1)+H.val(48,3)+H.val(81,3))/2.0;
    H.val(24,3)=H.val(22,1); //(1.0+r1)*(1.0-r2)*(1.0-r3)/8.0 - (H.val(43,1)+H.val(48,3)+H.val(81,3))/2.0;
    ...
    H.val(10,1)=(1.0+r1)*(1.0-r2)*(1.0+r3)*0.125 - (H.val(33,3)+H.val(36,3)+H.val(81,3))*0.5;
    H.val(11,2)=H.val(10,1); //(1.0+r1)*(1.0-r2)*(1.0+r3)/8.0 - (H.val(33,3)+H.val(36,3)+H.val(81,3))/2.0;
    H.val(12,3)=H.val(10,1); //(1.0+r1)*(1.0-r2)*(1.0+r3)/8.0 - (H.val(33,3)+H.val(36,3)+H.val(81,3))/2.0;
...
////#############################################################################
//  tensor TwentySevenNodeBrick::mass_tensor(Elastic  mmodel)
...
tensor TwentySevenNodeBrick::Nodal_Coordinates(void)
  {
    ...
    N_coord.val(21,1)=nd21Crds(0); N_coord.val(21,2)=nd21Crds(1); N_coord.val(21,3)=nd21Crds(2);
    N_coord.val(22,1)=nd22Crds(0); N_coord.val(22,2)=nd22Crds(1); N_coord.val(22,3)=nd22Crds(2);
    N_coord.val(23,1)=nd23Crds(0); N_coord.val(23,2)=nd23Crds(1); N_coord.val(23,3)=nd23Crds(2);
    N_coord.val(24,1)=nd24Crds(0); N_coord.val(24,2)=nd24Crds(1); N_coord.val(24,3)=nd24Crds(2);
    N_coord.val(25,1)=nd25Crds(0); N_coord.val(25,2)=nd25Crds(1); N_coord.val(25,3)=nd25Crds(2);
    N_coord.val(26,1)=nd26Crds(0); N_coord.val(26,2)=nd26Crds(1); N_coord.val(26,3)=nd26Crds(2);
    N_coord.val(27,1)=nd27Crds(0); N_coord.val(27,2)=nd27Crds(1); N_coord.val(27,3)=nd27Crds(2);
...
tensor TwentySevenNodeBrick::incr_disp(void)
  {
    ...
    increment_disp.val(21,1)=IncrDis21(0); increment_disp.val(21,2)=IncrDis21(1);increment_disp.val(21,3)=IncrDis21(2);
    increment_disp.val(22,1)=IncrDis22(0); increment_disp.val(22,2)=IncrDis22(1);increment_disp.val(22,3)=IncrDis22(2);
    increment_disp.val(23,1)=IncrDis23(0); increment_disp.val(23,2)=IncrDis23(1);increment_disp.val(23,3)=IncrDis23(2);
    increment_disp.val(24,1)=IncrDis24(0); increment_disp.val(24,2)=IncrDis24(1);increment_disp.val(24,3)=IncrDis24(2);
    increment_disp.val(25,1)=IncrDis25(0); increment_disp.val(25,2)=IncrDis25(1);increment_disp.val(25,3)=IncrDis25(2);
    increment_disp.val(26,1)=IncrDis26(0); increment_disp.val(26,2)=IncrDis26(1);increment_disp.val(26,3)=IncrDis26(2);
    increment_disp.val(27,1)=IncrDis27(0); increment_disp.val(27,2)=IncrDis27(1);increment_disp.val(27,3)=IncrDis27(2);
...
tensor TwentySevenNodeBrick::total_disp(void)
  {
    ...
    opserr << "tot node " << theNodes[20]->getTag() << " x " << TotDis21(0) <<" y "<< TotDis21(1) << " z "<< TotDis21(2) << endln;
    const Vector &TotDis22 = theNodes[21]->getTrialDisp();
    opserr << "tot node " << theNodes[21]->getTag() << " x " << TotDis22(0) <<" y "<< TotDis22(1) << " z "<< TotDis22(2) << endln;
    const Vector &TotDis23 = theNodes[22]->getTrialDisp();
    opserr << "tot node " << theNodes[22]->getTag() << " x " << TotDis23(0) <<" y "<< TotDis23(1) << " z "<< TotDis23(2) << endln;
    const Vector &TotDis24 = theNodes[23]->getTrialDisp();
    opserr << "tot node " << theNodes[23]->getTag() << " x " << TotDis24(0) <<" y "<< TotDis24(1) << " z "<< TotDis24(2) << endln;
    const Vector &TotDis25 = theNodes[24]->getTrialDisp();
    opserr << "tot node " << theNodes[24]->getTag() << " x " << TotDis25(0) <<" y "<< TotDis25(1) << " z "<< TotDis25(2) << endln;
    const Vector &TotDis26 = theNodes[25]->getTrialDisp();
    opserr << "tot node " << theNodes[25]->getTag() << " x " << TotDis26(0) <<" y "<< TotDis26(1) << " z "<< TotDis26(2) << endln;
    const Vector &TotDis27 = theNodes[26]->getTrialDisp();
    opserr << "tot node " << theNodes[26]->getTag() << " x " << TotDis27(0) <<" y "<< TotDis27(1) << " z "<< TotDis27(2) << endln;
    ...
    total_disp.val(21,1)=TotDis21(0); total_disp.val(21,2)=TotDis21(1);total_disp.val(21,3)=TotDis21(2);
    total_disp.val(22,1)=TotDis22(0); total_disp.val(22,2)=TotDis22(1);total_disp.val(22,3)=TotDis22(2);
    total_disp.val(23,1)=TotDis23(0); total_disp.val(23,2)=TotDis23(1);total_disp.val(23,3)=TotDis23(2);
    total_disp.val(24,1)=TotDis24(0); total_disp.val(24,2)=TotDis24(1);total_disp.val(24,3)=TotDis24(2);
    total_disp.val(25,1)=TotDis25(0); total_disp.val(25,2)=TotDis25(1);total_disp.val(25,3)=TotDis25(2);
    total_disp.val(26,1)=TotDis26(0); total_disp.val(26,2)=TotDis26(1);total_disp.val(26,3)=TotDis26(2);
    total_disp.val(27,1)=TotDis27(0); total_disp.val(27,2)=TotDis27(1);total_disp.val(27,3)=TotDis27(2);
...
//////#############################################################################
//int * TwentySevenNodeBrick::get_LM(void)
//  {
//    return 0;
//  }
...
//////#############################################################################
//void TwentySevenNodeBrick::set_LM(Node * node)
//  {
...
//           }
    ...
    //}
    //else {
                 //   g3ErrorHandler->fatal("TwentySevenNodeBrick::nodal_forces (tag: %d), could not getStress", this->getTag());
    //   exit(1);
    //}
            ...
            for( short GP_c_t = 1 ; GP_c_t <= t_integration_order ; GP_c_t++ )
              {
                ...
                ((GP_c_r-1)*s_integration_order+GP_c_s-1)*t_integration_order+GP_c_t-1;
                //.....
                //.....::printf("TwentySevenNodeBrick::iterative_nodal_forces(void)  ----**************** where = %d \n", where);
                //.....::printf("UPDATE ");
                //.....::printf("   GP_c_r = %d,  GP_c_s = %d,  GP_c_t = %d\n",
                //.....                           GP_c_r,GP_c_s,GP_c_t);
                // derivatives of local coordiantes with respect to local coordiantes
...
tensor TwentySevenNodeBrick::linearized_nodal_forces(void)
  {
    ...
    if ( ! (matpoint[where]->matmodel)->setTrialStrainIncr( incremental_strain)  )
      opserr << "TwentySevenNodeBrick::linearized_nodal_forces (tag: " << this->getTag() << "), not converged\n";
...
//....void TwentySevenNodeBrick::update_stress_strain(tensor & displacementsT)
//....  {
//....//    int force_dim[] = {20,3};
//....//    tensor nodal_forces(2,force_dim,0.0);
//....
...
////#############################################################################
////#############################################################################
//double TwentySevenNodeBrick::get_first_q_ast(void)
//  {
...
//  }
////#############################################################################
//double TwentySevenNodeBrick::get_first_etacone(void)
//  {
...
//#############################################################################
void TwentySevenNodeBrick::report(char * msg)
  {
    if ( msg ) ::printf("** %s",msg);
    ::printf("\n Element Number = %d\n", this->getTag() );
    ...
    if ( total_number_of_Gauss_points != 0 )
     ...
     theNodes[20]->Print(opserr);
     theNodes[21]->Print(opserr);
     theNodes[22]->Print(opserr);
     theNodes[23]->Print(opserr);
     theNodes[24]->Print(opserr);
     theNodes[25]->Print(opserr);
     theNodes[26]->Print(opserr);
...
//#############################################################################
void TwentySevenNodeBrick::reportshort(char * msg)
  {
    if ( msg ) ::printf("** %s",msg);
    ::printf("\n Element Number = %d\n", this->getTag() );
    ::printf("\n Number of nodes in a TwentySevenNodeBrick = %d\n",
...
//#############################################################################
void TwentySevenNodeBrick::reportPAK(char * msg)
  {
    if ( msg ) ::printf("%s",msg);
...
//#############################################################################
void TwentySevenNodeBrick::reportpqtheta(int GP_numb)
  {
...
//#############################################################################
//void TwentySevenNodeBrick::reportLM(char * msg)
//  {
//    if ( msg ) ::printf("%s",msg);
...
//#############################################################################
//void TwentySevenNodeBrick::reportTensor(char * msg)
// ZHaohui added to print gauss point coord. to file fp

void TwentySevenNodeBrick::reportTensorF(FILE * fp)
  {
    //if ( msg ) ::printf("** %s\n",msg);
...
void TwentySevenNodeBrick::setDomain (Domain *theDomain)
{
  ...
  theNodes[8] = 0;
    ...
    theNodes[8]  == 0 || theNodes[9] == 0 || theNodes[10] == 0 || theNodes[11] == 0 ||
        ...
        opserr << "FATAL ERROR TwentySevenNodeBrick (tag: " << this->getTag() << " ), node not found in domain\n";
  exit(-1);
      }
      ...
      if (dofNd1  != 3 || dofNd2  != 3 || dofNd3  != 3 || dofNd4  != 3 ||
        ...
        opserr << "FATAL ERROR TwentySevenNodeBrick (tag: " << this->getTag() <<
...
int TwentySevenNodeBrick::commitState ()
{
  ...
  if ((retVal = this->Element::commitState()) != 0) {
    opserr << "TwentySevenNodeBrick::commitState () - failed in base class";
  }
...
{
  //opserr << "WARNING - TwentySevenNodeBrick::getInitialStiff() - not yet implemented\n";
...
{
    //g3ErrorHandler->warning("TwentySevenNodeBrick::addLoad - load type unknown for ele with tag: %d\n",
    //                        this->getTag());
    ...
    if (type == LOAD_TAG_BrickSelfWeight) {
      ...
      opserr << "TwentySevenNodeBrick::addLoad() - 20NodeBrick " << this->getTag() <<
...
////=============================================================================
//int  TwentySevenNodeBrick::addLoad(const Vector &addLoad)
//{
//     if (addLoad.Size() != 81) {
//       opserr << "TwentySevenNodeBrick::addLoad %s\n",
...
opserr << "TwentySevenNodeBrick::addInertiaLoadToUnbalance " <<
...
//void TwentySevenNodeBrick::setInitE(void)
//{
...
//=============================================================================
int TwentySevenNodeBrick::displaySelf (Renderer &theViewer, int displayMode, float fact)
{
...
//=============================================================================
void TwentySevenNodeBrick::Print(OPS_Stream &s, int flag)
{
...
Response * TwentySevenNodeBrick::setResponse (const char **argv, int argc, Information &eleInformation)
{
    ...
    {
       return new ElementResponse(this, 3, InfoStress);
    }
    //========================================================
    else if (strcmp(argv[0],"stress") == 0 || strcmp(argv[0],"stresses") == 0)
    {
       return new ElementResponse(this, 4, InfoStress);
    }

    //========================================================
    else if (strcmp(argv[0],"pq") == 0 || strcmp(argv[0],"PQ") == 0)
    {
       return new ElementResponse(this, 41, Info_pq2);
    }
...
//=============================================================================
int TwentySevenNodeBrick::getResponse (int responseID, Information &eleInfo)
{
       switch (responseID) {
    ...
    //opserr << " Zz " << GaussCoord(3) << " " << GaussCoord(6) << " "<< GaussCoord(9) << endln;
    ...
    //Q(0) = 0; Q(1) = 0; Q(2) = 0;
      ...
      for( short GP_c_t = 1 ; GP_c_t <= t_integration_order ; GP_c_t++ )
        ...
        //    sts.print();
        //    opserr << " rs " << rs << "\n "<< InfoMoment(i*4+1) << " " ;
        //    opserr << InfoMoment(i*4+2) << " "<< InfoMoment(i*4+3)<< " sts "<< InfoMoment(i*4+4) << "\n ";
              //}
        if (strcmp(tp, "ElasticIsotropic3D") == 0 ){
    ...
    //Vector InfoMoment(109 + 3 ); //Z values, x-disp. and corresponding avg. moment
    InfoStress(0) = count;
...
//const Matrix&
//TwentySevenNodeBrick::getTangentStiff ()
//{
...
//const Matrix&
//TwentySevenNodeBrick::getSecantStiff ()
//{
//  return K;
//}

//Commented by Xiaoyan     Use the form like Brick3d
//const Matrix & TwentySevenNodeBrick::getDamp ()
//{
//  return C;
//}
...
//
//const Vector&
//TwentySevenNodeBrick::getResistingForce ()
//{
//  int order = theQuadRule->getOrder();
//  const Vector &intPt = theQuadRule->getIntegrPointCoords();
//  const Vector &intWt = theQuadRule->getIntegrPointWeights();
...
//
//const Vector&
//TwentySevenNodeBrick::getResistingForceIncInertia ()
//{
//  // Yet to implement
//  return P;
//}
...
//
//void
//TwentySevenNodeBrick::Print (OPS_Stream &s, int flag)
//{
//  s << "TwentySevenNodeBrick, element id:  " << this->getTag() << endln;
//  s << "Connected external nodes:  " << connectedExternalNodes;
...
//
//int
//TwentySevenNodeBrick::displaySelf (Renderer &theViewer, int displayMode, float fact)
//{
    // first determine the end points of the quad based on
    // the display factor (a measure of the distorted image)
...
//
//void
//TwentySevenNodeBrick::formNMatrix (double r, double s,double t)
...
// }
//void
//TwentySevenNodeBrick::setJacobian (double r, double s, double t)
////Changed xi, eta to r,s and added t Xiaoyan 07/06/00
//{
//  const Vector &nd1Crds = theNodes[0]->getCrds();
//  const Vector &nd2Crds = theNodes[1]->getCrds();
...
//
//void
//TwentySevenNodeBrick::formBMatrix (double r, double s, double t)
////Changed xi, eta to r,s and added t Xiaoyan  07/06/00
//{
//    B.Zero();
//
...
//double
//TwentySevenNodeBrick::formDetJ (double r, double s, double t)
//{
