...
#define MP_SimpleJoint2D_h

// Written: Arash
// Created: 08/01

// Purpose: This file contains the class definition for MP_SimpleJoint2D.
// It is a sub class for MP_Constraint specialized to be used for simple joint 
// connection element. MP_SimpleJoint2D defines a nonlinear, time dependent multi 
// point constraint.
//
...
class MP_SimpleJoint2D : public MP_Constraint
{
  public:
    // constructors        
    MP_SimpleJoint2D();

    MP_SimpleJoint2D( Domain *theDomain, int tag, int nodeRetain, int nodeConstr,
