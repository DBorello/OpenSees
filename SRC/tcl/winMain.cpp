 ...
 *
 * RCS: @(#) $Id: winMain.cpp,v 1.1 2001-08-18 00:22:12 fmk Exp $
 */
...
void Tk_MainOpenSees(int argc, char **argv,Tcl_AppInitProc *appInitProc, 
					 Tcl_Interp *interp);
...
int main(int argc, char **argv)
{
    ...
    Tk_MainOpenSees(argc, argv, Tcl_AppInit, Tcl_CreateInterp());
    return 0;
}
