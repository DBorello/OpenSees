...
#ifndef FAFourSteelPCPlaneStress_h
#define FAFourSteelPCPlaneStress_h

// File: FAFourSteelPCPlaneStress.h
//
// Written: ALaskar
// Created: 2007.09
//
// Description: This file contains the class definition for 
// FAFourSteelPCPlaneStress material.
// Hsu's Model 2002
...
class FAFourSteelPCPlaneStress : public NDMaterial
{
  public:
  FAFourSteelPCPlaneStress ( int      tag, 
			     double   RHO,
			     UniaxialMaterial *t1,
			     UniaxialMaterial *t2,
			     UniaxialMaterial *s1,
 ...
 private:
  ...
  double   rou1;      // steel ratio of the first tendon layer
  double   rou2;      // steel ratio of the second tendon layer
