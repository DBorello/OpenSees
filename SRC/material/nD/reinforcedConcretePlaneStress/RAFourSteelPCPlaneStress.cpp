...
//Vector RAFourSteelPCPlaneStress :: strain_vec(3);
//Vector RAFourSteelPCPlaneStress :: stress_vec(3);
//Matrix RAFourSteelPCPlaneStress :: tangent_matrix(3,3);
...
OPS_Export void *
OPS_NewRAFourSteelPCPlaneStressMaterial()
{
