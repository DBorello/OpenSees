...
//Vector FAPrestressedConcretePlaneStress :: strain_vec(3);
//Vector FAPrestressedConcretePlaneStress :: stress_vec(3);
//Matrix FAPrestressedConcretePlaneStress :: tangent_matrix(3,3);
...
OPS_NewFAPrestressedConcretePlaneStressMaterial()
{
  if (numFAPrestressedConcretePlaneStressMaterials == 0) {
    ...
    OPS_Error("FAPrestressedConcretePlaneStress unaxial material - Written by J.Zhong, Thomas T.C. Hsu and Y.L. Mo - Copyright@2009\n", 1);
  }
