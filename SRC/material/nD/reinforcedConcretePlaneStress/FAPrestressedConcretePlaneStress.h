#ifndef FAPrestressedConcretePlaneStress_h
#define FAPrestressedConcretePlaneStress_h
...
// FAPrestressedConcretePlaneStress material.
// Hsu's Model 2002
...
class FAPrestressedConcretePlaneStress : public NDMaterial
{
 public:
  FAPrestressedConcretePlaneStress ( int      tag, 
				     double   RHO,
				     UniaxialMaterial *t1,
				     UniaxialMaterial *s1,
				     UniaxialMaterial *c1,
 ...
 private:
  ...
  double	 pstrain;	// strain in prestressing tendon
